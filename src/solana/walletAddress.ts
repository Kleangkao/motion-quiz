...
interface WalletStandardAccountLike {
  address?: string;
}

/**
 * Normalize wallet public keys / addresses from injected wallets, Wallet Standard,
 * or plain strings. Never throws on unexpected shapes.
 */
